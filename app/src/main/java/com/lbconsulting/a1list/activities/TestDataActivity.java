...
public class TestDataActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void uploadTestAttributes() {
        ...
        attributes.setName("Genoa");
        attributes.setAuthor(ParseUser.getCurrentUser());
        attributes.setBold(true);
        attributes.setChecked(false);
        attributes.setStartColor(ContextCompat.getColor(this, R.color.genoa_start));
        attributes.setEndColor(ContextCompat.getColor(this, R.color.genoa_end));
        attributes.setTextColor(ContextCompat.getColor(this, R.color.white));
        attributes.setTextSize(15);
        attributes.setHorizontalPaddingDp(5);
        attributes.setVerticalPaddingDp(10);
        attributes.setBackgroundTransparent(false);
        listAttributes.add(attributes);

        attributes = new ListAttributes();
        attributes.setName("Opal");
        attributes.setAuthor(ParseUser.getCurrentUser());
        attributes.setBold(false);
        attributes.setChecked(false);
        attributes.setStartColor(ContextCompat.getColor(this, R.color.opal_start));
        attributes.setEndColor(ContextCompat.getColor(this, R.color.opal_end));
        attributes.setTextColor(ContextCompat.getColor(this, R.color.black));
        attributes.setTextSize(17);
        attributes.setHorizontalPaddingDp(10);
        attributes.setVerticalPaddingDp(15);
        attributes.setBackgroundTransparent(false);
        listAttributes.add(attributes);

        attributes = new ListAttributes();
        attributes.setName("Shades of Blue");
        attributes.setAuthor(ParseUser.getCurrentUser());
        attributes.setBold(false);
        attributes.setChecked(false);
        attributes.setStartColor(Color.parseColor("#A7D5F2"));
        attributes.setEndColor(Color.parseColor("#5A90BF"));
        attributes.setTextColor(ContextCompat.getColor(this, R.color.black));
        attributes.setTextSize(21);
        attributes.setHorizontalPaddingDp(20);
        attributes.setVerticalPaddingDp(30);
        attributes.setBackgroundTransparent(false);
        listAttributes.add(attributes);

        attributes = new ListAttributes();
        attributes.setName("Off White");
        attributes.setAuthor(ParseUser.getCurrentUser());
        attributes.setBold(false);
        attributes.setChecked(false);
        attributes.setStartColor(ContextCompat.getColor(this, R.color.white));
        attributes.setEndColor(Color.parseColor("#DAD3CD"));
        attributes.setTextColor(ContextCompat.getColor(this, R.color.black));
        attributes.setTextSize(17);
        attributes.setHorizontalPaddingDp(10);
        attributes.setVerticalPaddingDp(1);
        attributes.setBackgroundTransparent(true);
        listAttributes.add(attributes);
